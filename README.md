...
* **Step 3:** Run ```run_all.sh```. Note that the preprocessing step was performed on cluster node with 64GB RAM and two Intel E5-2630 v3 2.4GHz CPU’s each having 8 cores. The final figures would be stored under a ```results``` directory.

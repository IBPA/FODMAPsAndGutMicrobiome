...
qiime feature-table merge\
    ...
    --i-tables ${S6_micr_data_dir}/PICRUSt_predicted_metagenomes_KEGG_L3.qza\
...
convert_metagenome_all ${S6_micr_data_dir}
...
qiime feature-table merge\
    ...
    --i-tables ${S6_micr_data_dir}/PICRUSt_metagenome_predictions.qza\

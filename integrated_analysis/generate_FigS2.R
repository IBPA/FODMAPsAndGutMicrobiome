#!/usr/bin/env Rscript
#' Generate Fig S2: Classification performance based on methane metabolism 
...
RF_MaxNodes <- 2
df_res <- s_classify_binary_RF_loo_cr(df_comb, x_cols = c("Methane.metabolism") , 
                                      label_col = "Response",
...
print(gPlot)
lib.util.load_fonts()
lib.util.ggsave(file.path("results", "FigS2.png"),
